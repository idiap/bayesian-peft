# Bayesian Parameter-Efficient Fine-Tuning for Overcoming Catastrophic Forgetting: customized Hugging Face PEFT package

This package is modified based on the Hugging Face [PEFT](https://github.com/huggingface/peft/tree/v0.6.0) version 0.6.0. It includes the implementation of the Bayesian transfer learning techniques with LoRA and supports the language modeling experiments.
