...
@click.option('--log_dir', default='Models/finetune_linear', type=str)
def main(config_path, seed, log_dir):
    ...
    # Set requires_grad=False for non-linear modules and static models, excluding full finetune models
    ...
    for model_name, m in model.items():
        if model_name in full_finetune_model_names:
            continue
    ...
    for epoch in range(start_epoch, epochs):
        ...
        for i, batch in enumerate(train_dataloader):
            ...
            # no active parameters in text_encoder
